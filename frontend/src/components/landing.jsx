...
import FiliereCourseSelector from './FiliereCourseSelector.jsx';
...
const Landing = () => {
  ...
  const {data ,error, isLoading , fetchDatafilier } = useFetch('/api/filiere/filieres')
 ...
 /*  const handleFiliereChange = (e) => {
    const filiereId = parseInt(e.target.value);
    const filiere = filieres.find(f => f.id === filiereId);
    setSelectedFiliere(filiere);
    setCourses(filiere?.courses || []);
    setSelectedCourse(null); // reset course on filiere change
  };
  ...
  return (
    <div className="flex flex-col bg-slate-100 min-h-[100vh] backgroud-landing">
      ...
      <ModalGeneralComponent
        ...
        <FiliereCourseSelector filieres={data}  />
        {/* 
